...
<!-- badges: start -->
[![Travis build status](https://travis-ci.com/fernandalschumacher/skewlmm.svg?branch=master)](https://travis-ci.com/fernandalschumacher/skewlmm)
<!-- badges: end -->
...
Schumacher, F.L., Lachos, V.H., and Matos, L.A. (2020+) "Scale mixture of skew-normal linear mixed models with within-subject serial dependence". Submitted. Preprint available at https://arxiv.org/abs/2002.01040.
